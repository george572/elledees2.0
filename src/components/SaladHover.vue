...
<template>
  <div
    class="absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full gap-0 px-2 transition-all duration-200 md:px-20 sm:gap-5 bg-opacity-80"
