  ...
  >
    <div class="flex flex-col md:flex-row justify-center items-center gap-5">
      <div class="w-full md:w-[50%] flex flex-col items-center">
        ...
        <div class="text-center text-lg font-[Geomanist]">
          ...
          <p class="pt-3">
            Des incontournables intemporels aux créations saisonnières, nous nous efforçons de concevoir un menu qui célèbre les saveurs du monde entier et qui accueille chaleureusement quiconque souhaite se joindre à notre table.
          </p>
        </div>
      </div>
    ...
    <div class="pt-5 text-center text-lg font-[Geomanist]">
      <p>
        ...
        mettons en place un réseau d'approvisionnement transparent, préparons nos plats à partir de matières premières brutes, et
        créons une communauté de fervents défenseurs de la nourriture authentique.
      </p>
    </div>
      ...
      <div class="w-full md:w-[50%] flex flex-col items-center">
        ...
        <div class="text-center text-lg font-[Geomanist]">
          <p class="pt-3">
            ...
            avons vu une opportunité de créer une entreprise où la qualité n'est jamais
            sacrifiée pour la commodité. Le 1er mars 2021, 1 an après avoir testé nos
            recettes en livraison uniquement, nous avons ouvert notre boutique dans le
            9ème à Paris et avons servi nos premiers clients avec une vision de réinventer
